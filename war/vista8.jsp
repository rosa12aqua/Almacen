...
<body background="jp1.jpeg">
	...
	<center>
		<table width="300" height="50%">
			<tr align="center">
				<td><h1>
						<font size="9" color="black">Bienvenido!<br>Registra
							un producto<br>
	...
	<center>
		<table border="2" bordercolor="black" width="250" heigth="150%"
			background="f2p.jpeg">
			<tr>
				<td><table>
						<tr>
									...
									<table>
										...
										<tr>
											<table>
												...
												<tr>
												<tr>
													<td><b><h5>Fecha entrada</h5></b></td>
													<td><input type="text" name="fent"></td>
												</tr>
												<tr>
													<td><b><h5>Fecha salida</h5></b></td>
													<td><input type="text" name="fsal"></td>
												</tr>
												<tr>
													<td><b><h5>Fecha caducidad</h5></b></td>
											...
											<input type="submit" name="este" value="Resgistrarse">
											<br>
											<br>
